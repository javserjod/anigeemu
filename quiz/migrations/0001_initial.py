    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('daily_challenge_number', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(choices=[('PENDING', 'Pending'), (
                    'CORRECT', 'Correct'), ('WRONG', 'Wrong')], default='PENDING', max_length=10)),
                ...
                ('game', models.ForeignKey(
                    on_delete=django.db.models.deletion.CASCADE, related_name='rounds', to='quiz.game')),
            ],
        ),
    ]
